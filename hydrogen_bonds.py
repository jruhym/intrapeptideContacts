...
donor_Nsp2_IVArg = HBondGroup()
donor_Nsp2_IVArg.set_valance("sp2")
donor_Nsp2_IVArg.set_residue("Arg")
donor_Nsp2_IVArg.set_H_bond_radius(1.90)
donor_Nsp2_IVArg.set_atoms_str_tupl(("NE",))
donor_Nsp2_IVArg.set_max_num_H_bonds(1)
donor_Nsp2_IVArg.set_NN("CZ")
donor_Nsp2_IVArg.set_NNN("CD")

donor_Nsp2_VHis = HBondGroup()
donor_Nsp2_VHis.set_valance("sp2")
donor_Nsp2_VHis.set_residue("His")
donor_Nsp2_VHis.set_H_bond_radius(1.90)
donor_Nsp2_VHis.set_atoms_str_tupl(("NE2",))
donor_Nsp2_VHis.set_max_num_H_bonds(1)
donor_Nsp2_VHis.set_NN("CE1")
donor_Nsp2_VHis.set_NNN("CD2")

donor_Nsp3_I_Lys = HBondGroup()
donor_Nsp3_I_Lys.set_valance("sp2")
...
donor_Osp3_I_Ser.set_valance("sp2")
...
donor_Osp3_I_Thr.set_valance("sp2")
...
donor_Osp2_I_Thr = HBondGroup()
donor_Osp2_I_Thr.set_valance("sp2")
donor_Osp2_I_Thr.set_residue("Tyr")
donor_Osp2_I_Thr.set_H_bond_radius(1.70)
donor_Osp2_I_Thr.set_atoms_str_tupl(("OH",))
donor_Osp2_I_Thr.set_max_num_H_bonds(1)
donor_Osp2_I_Thr.set_NN("CZ")
donor_Osp2_I_Thr.set_NNN("CE1")
